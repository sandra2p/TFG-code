...
declare namespace Mov_financingEnum {
}

declare namespace Xrm {
    type Mov_financing = Omit<FormContext, 'getAttribute'> & Omit<FormContext, 'getControl'> & Mov_financingAttributes;

    interface EventContext {
        getFormContext(): Mov_financing;
    }

    interface Mov_financingAttributes {
        ...
        getAttribute(name: "mov_financingid"): Attributes.StringAttribute;
        ...
        getAttribute(name: "mov_name"): Attributes.StringAttribute;
        ...
        getControl(name: "mov_financingid"): Controls.StringControl;
        ...
        getControl(name: "mov_name"): Controls.StringControl;
