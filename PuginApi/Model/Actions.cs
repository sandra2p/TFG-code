...
namespace CrmEarlyBound
{
	...
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/new/")]
	[Microsoft.Xrm.Sdk.Client.RequestProxyAttribute("mov_TestApi")]
	public partial class mov_TestApiRequest : Microsoft.Xrm.Sdk.OrganizationRequest
	{
		
		public string mov_Field_Name
		{
			get
			{
				if (this.Parameters.Contains("mov_Field_Name"))
				{
					return ((string)(this.Parameters["mov_Field_Name"]));
				}
				else
				{
					return default(string);
			...
			set
			{
				this.Parameters["mov_Field_Name"] = value;
			}
		}
		
		public string mov_TargetEntity_Name
		{
			get
			{
				if (this.Parameters.Contains("mov_TargetEntity_Name"))
				{
					return ((string)(this.Parameters["mov_TargetEntity_Name"]));
				}
				else
				{
					return default(string);
			...
			set
			{
				this.Parameters["mov_TargetEntity_Name"] = value;
			}
		}
		
		public string mov_TargetEntityId
		{
			get
			{
				if (this.Parameters.Contains("mov_TargetEntityId"))
				{
					return ((string)(this.Parameters["mov_TargetEntityId"]));
				}
				else
				{
					return default(string);
			...
			set
			{
				this.Parameters["mov_TargetEntityId"] = value;
			}
		}
		
		public mov_TestApiRequest()
		{
			this.RequestName = "mov_TestApi";
			this.mov_Field_Name = default(string);
			this.mov_TargetEntity_Name = default(string);
			this.mov_TargetEntityId = default(string);
		}
	}
	
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/new/")]
	[Microsoft.Xrm.Sdk.Client.ResponseProxyAttribute("mov_TestApi")]
	public partial class mov_TestApiResponse : Microsoft.Xrm.Sdk.OrganizationResponse
	{
		
		public mov_TestApiResponse()
		{
		}
		
		public string mov_Response
		{
			get
			{
				if (this.Results.Contains("mov_Response"))
				{
					return ((string)(this.Results["mov_Response"]));
				}
				else
				{
					return default(string);
	...
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/new/")]
	[Microsoft.Xrm.Sdk.Client.RequestProxyAttribute("mov_customapi")]
	public partial class mov_customapiRequest : Microsoft.Xrm.Sdk.OrganizationRequest
	{
		
		public bool mov_Field_Name
		{
			get
			{
				if (this.Parameters.Contains("mov_Field_Name"))
				{
					return ((bool)(this.Parameters["mov_Field_Name"]));
				}
				else
				{
					return default(bool);
		...
		public bool mov_TargetEntity_Name
		{
			get
			{
				if (this.Parameters.Contains("mov_TargetEntity_Name"))
				{
					return ((bool)(this.Parameters["mov_TargetEntity_Name"]));
				}
				else
				{
					return default(bool);
		...
		public bool mov_TargetEntityId
		{
			get
			{
				if (this.Parameters.Contains("mov_TargetEntityId"))
				{
					return ((bool)(this.Parameters["mov_TargetEntityId"]));
				}
				else
				{
					return default(bool);
		...
		public mov_customapiRequest()
		{
			this.RequestName = "mov_customapi";
			this.mov_Field_Name = default(bool);
			this.mov_TargetEntity_Name = default(bool);
			this.mov_TargetEntityId = default(bool);
		}
	}
	
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/new/")]
	[Microsoft.Xrm.Sdk.Client.ResponseProxyAttribute("mov_customapi")]
	public partial class mov_customapiResponse : Microsoft.Xrm.Sdk.OrganizationResponse
	{
		
		public mov_customapiResponse()
		{
		}
		
		public bool mov_Response
		{
			get
			{
				if (this.Results.Contains("mov_Response"))
				{
					return ((bool)(this.Results["mov_Response"]));
				}
				else
				{
					return default(bool);
